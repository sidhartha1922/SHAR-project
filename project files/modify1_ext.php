...
<form method="POST" action="modify2_ext.php" id="addext">
...
<label for="type">Type of Programme</label>  Conference<input type="radio" name="type" value="conference" <?php if($row['type']=="conference") echo 'checked="checked"';?>/>
                                             Training<input type="radio" name="type" value="training" <?php if($row['type']=="training") echo 'checked="checked"';?>/>
					     Workshop<input type="radio" name="type" value="workshop" <?php if($row['type']=="workshop") echo 'checked="checked"';?>/>
                                             Seminar<input type="radio" name="type" value="seminar" <?php if($row['type']=="seminar") echo 'checked="checked"';?>/><br/>
<label for="organiser">Name of Oraganiser</label>
<input type="text" name="organiser" value="<?php echo $row['organiser']?>"/><br/>
<label for="fee">Fee</label>
<input type="number" name="fee" value="<?php echo $row['fee']?>"/><br/>
