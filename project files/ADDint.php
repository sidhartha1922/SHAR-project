...
if($pnameerr=="" && $pcodeerr=="" && $sdateerr=="" && $edateerr=="" && $scodeerr=="" && $nameerr=="" && $desigerr=="" && $centererr=="" && $gendererr=="" && $categoryerr==""){
/*input($_POST['pname'],$_POST['pcode'],$_POST['sdate'],$_POST['edate'],$_POST['scode'],$_POST['name'],$_POST['desig'],$_POST['center'] );*/
include 'input_int.php';
exit();
}}?>
...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="addint">
...
<input type="date" name="sdate" value=""/><small>yyyy-mm-dd</small><span class="error"><?php echo $sdateerr;?></span><br/><br/>
<label for="edate">End Date</label>
<input type="date" name="edate" value=""/><small>yyyy-mm-dd</small><span class="error"><?php echo $edateerr;?></span><br/><br/>
