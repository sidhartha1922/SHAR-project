...
$res=mysqli_query($link,"SELECT DISTINCT `Program code` FROM `add_int`");
...
$sc=$_SESSION["scode"];
$res1=mysqli_query($link,"SELECT * FROM `hrdd internal`.`add_int` WHERE `Program code`='$pg' AND `staff code`='$scode'");
